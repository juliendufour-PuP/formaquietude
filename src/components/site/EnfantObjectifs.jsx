        ...
        <div className="mt-16 grid lg:grid-cols-[1.35fr_1fr] gap-10 items-start">
          ...
          <div className="flex flex-col gap-5">
            <motion.div
              ...
              className="rounded-[22px] bg-[#f5eee9] p-7"
            >
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((s, i) => (
                <motion.div
                  ...
                  className="rounded-[22px] bg-[#2a1f61] p-6 text-white text-center flex flex-col items-center justify-center"
                >
            ...
            <p className="text-[12px] text-center text-[#232049]/50">Chiffres 2021</p>
          </div>
        </div>
      </div>
    </section>
