    ...
    <section id="methode" className="bg-white py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8">
        <SectionHeading
          ...
          subtitle="Un parcours en quatre temps, réservé aux personnes qui accompagnent déjà les enfants dans leur activité quotidienne."
        />
        ...
        <div className="mt-16 grid lg:grid-cols-[1fr_1fr] gap-14 items-center">
          ...
          <div className="flex flex-col gap-9">
            <div className="rounded-[22px] bg-[#f4f4f9] border border-[#ff6b00]/20 p-6">
              <div className="flex items-center gap-3">
                <Users className="w-5 h-5 text-[#ff6b00]" />
                <h3 className="font-display text-xl font-semibold text-[#2a1f61]">À qui s’adressent ces formations&nbsp;?</h3>
              </div>
              <p className="mt-3 text-[15px] leading-relaxed text-[#2a1f61]/70">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {[
                  ...
                  <span key={p} className="rounded-full bg-white border border-[#2a1f61]/10 px-3 py-1.5 text-[12.5px] font-medium text-[#2a1f61]/75">
                    {p}
                  </span>
                ))}
              </div>
              <p className="mt-4 text-[13px] leading-relaxed text-[#2a1f61]/55">
            ...
            <ol className="space-y-8">
              {steps.map((s, i) => (
                ...
                >
                  ...
                  <span className="absolute left-[22px] top-11 bottom-[-20px] w-px bg-gradient-to-b from-[#ff6b00]/40 to-transparent last:hidden" />
