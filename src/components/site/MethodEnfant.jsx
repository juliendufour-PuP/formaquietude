...
export default function MethodEnfant() {
  return (
    <>
      <section className="bg-[#2a1f61] py-16 lg:py-20">
        <div className="mx-auto max-w-[1400px] px-5 sm:px-8">
          <motion.div
            ...
            className="rounded-[26px] bg-white/[0.04] border border-white/10 p-8 sm:p-10"
          >
            <div className="flex flex-col lg:flex-row items-start lg:items-center gap-8 lg:gap-12">
              <div className="flex-1">
                <div className="flex items-center gap-3">
                  <span className="flex items-center justify-center w-11 h-11 rounded-full bg-[#ff6b00]/15 text-[#ff6b00]">
              ...
              <div className="flex flex-wrap gap-2 lg:max-w-[42%] lg:justify-end">
                {audience.map((p) => (
                  <span
                    key={p}
                    className="rounded-full bg-white/10 border border-white/15 px-3.5 py-1.5 text-[13px] font-medium text-white/85"
                  >
                    {p}
                  </span>
                ))}
